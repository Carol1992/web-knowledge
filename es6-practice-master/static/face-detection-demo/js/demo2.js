	...
	var App = {
		...
		init: function () {
			...
			if ( !!this.options ) {
				...
				//upload
				this.addEvent('click', this.uploadBtn, this.uploadPic)
		...
		options: {
			...
			onSave: function (data) {
				...
				if (App.pos >= 4 * w * h) { 
					...
					App.pos = 0;
					App.data_url = App.canvas.toDataURL();
					document.getElementById('img').src = App.data_url;
				}
